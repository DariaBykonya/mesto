...
let nameInput = document.querySelector('.popup__input_type_name').value; // Воспользуйтесь инструментом .querySelector()
let jobInput = document.querySelector('.popup__input_type_job').value;
// Обработчик «отправки» формы, хотя пока
// она никуда отправляться не будет
let rename = document.querySelector('.profile__name');
let editJob = document.querySelector('.profile__text').value;
